...
export const Projects: React.FC<ProjectsProps> = ({ isModalOpen, setIsModalOpen }) => {
  ...
  const projectsData: Project[] = [
    ...
    },
    {
      ...
      category: 'IoT',
      shortDesc: 'Sistem kontrol akses pintu berbasis RFID yang terintegrasi dengan IoT untuk keamanan.',
      fullDesc: 'Proyek IoT yang menggabungkan teknologi RFID dan konektivitas internet untuk mengontrol akses pintu secara otomatis. Sistem ini memungkinkan pengguna terdaftar untuk membuka pintu menggunakan kartu RFID.',
      features: [
        'Akses pintu otomatis berbasis kartu RFID',
        'Sistem manajemen pengguna dan hak akses',
        'Sistem peringatan jika ada percobaan akses tidak sah',
      ],
      stack: ['ESP32', 'C++', 'Arduino IDE'],
      demoUrl: '#',
